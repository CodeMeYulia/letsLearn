...
//         e.preventDefault();
//         const fixedWord = { english, transcription, russian, tags };
...
//                 </label>
//                 <label >
//                     <input type="text" className='inputs' placeholder={fixedWord.tags} name="tags" onChange={(e) => setTags(e.target.value)} value={tags} />
//                 </label>
//                 <div>
